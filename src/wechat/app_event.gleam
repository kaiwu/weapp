...
pub fn on_unhandled_rejection(callback cb: WechatResultCallback) -> Nil

/// `wx.onLazyLoadError`
/// Listen for lazy load error
///
@external(javascript, "../wechat_base_ffi.mjs", "onLazyLoadError")
pub fn on_lazy_load_error(callback cb: WechatResultCallback) -> Nil
